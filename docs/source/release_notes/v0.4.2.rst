...
Bug fixes
--------------
- Fix missing default general parameters in DAT class (`issue <https://github.com/People-Places-Solutions/floodmodeller-api/issues/61>`__)
- Fix XML2D multi-value key issue (`issue <https://github.com/People-Places-Solutions/floodmodeller-api/issues/52>`__)

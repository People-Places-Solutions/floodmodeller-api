...
def test_network(test_workspace: Path):
    ...
    expected_edges = [
        ...
        (("QTBDY", "CS26"), ("RIVER", "CS26")),
        (("RIVER", "CS26"), ("RIVER", "CS25")),
        (("RIVER", "CS25"), ("RIVER", "CS24")),
        (("RIVER", "CS25"), ("SPILL", "RD25Su")),
        (("RIVER", "CS24"), ("RIVER", "CS23")),
        (("RIVER", "CS24"), ("SPILL", "RD24Su")),
        (("RIVER", "CS23"), ("RIVER", "CS22")),
        (("RIVER", "CS23"), ("SPILL", "RD23Su")),
        (("RIVER", "CS22"), ("RIVER", "CS21")),
        (("RIVER", "CS22"), ("SPILL", "RD22Su")),
        (("RIVER", "CS21"), ("RIVER", "CS20")),
        (("RIVER", "CS21"), ("SPILL", "RD21Su")),
        (("RIVER", "CS20"), ("RIVER", "CS19")),
        (("RIVER", "CS20"), ("SPILL", "RD20Su")),
        (("RIVER", "CS19"), ("RIVER", "CS18")),
        (("RIVER", "CS19"), ("SPILL", "RD19Su")),
        (("RIVER", "CS18"), ("RIVER", "RESOUT2a")),
        (("RIVER", "CS18"), ("SPILL", "RD18Su")),
        (("RIVER", "RESOUT2a"), ("RIVER", "RESOUT2b")),
        (("RIVER", "RESOUT2b"), ("JUNCTION", "RESOUT2b")),
        (("JUNCTION", "RESOUT2b"), ("RIVER", "RESOUT2u")),
        (("JUNCTION", "RESOUT2b"), ("RIVER", "RESOUT2d")),
        (("RIVER", "resin"), ("RIVER", "CSRD25")),
        (("RIVER", "CSRD25"), ("RIVER", "CSRD24")),
        (("RIVER", "CSRD25"), ("SPILL", "RD25Su")),
        (("RIVER", "CSRD24"), ("RIVER", "CSRD23")),
        (("RIVER", "CSRD24"), ("SPILL", "RD24Su")),
        (("RIVER", "CSRD23"), ("RIVER", "CSRD22")),
        (("RIVER", "CSRD23"), ("SPILL", "RD23Su")),
        (("RIVER", "CSRD22"), ("RIVER", "CSRD21")),
        (("RIVER", "CSRD22"), ("SPILL", "RD22Su")),
        (("RIVER", "CSRD21"), ("RIVER", "CSRD20")),
        (("RIVER", "CSRD21"), ("SPILL", "RD21Su")),
        (("RIVER", "CSRD20"), ("RIVER", "CSRD19")),
        (("RIVER", "CSRD20"), ("SPILL", "RD20Su")),
        (("RIVER", "CSRD19"), ("RIVER", "CSRD18")),
        (("RIVER", "CSRD19"), ("SPILL", "RD19Su")),
        (("RIVER", "CSRD18"), ("RIVER", "CSRD17")),
        (("RIVER", "CSRD18"), ("SPILL", "RD18Su")),
        (("RIVER", "CSRD17"), ("RIVER", "CSRD16")),
        (("RIVER", "CSRD16"), ("RIVER", "CSRD15")),
        (("RIVER", "CSRD15"), ("RIVER", "CSRD14u")),
        (("RIVER", "CSRD14u"), ("JUNCTION", "CSRD14u")),
        (("JUNCTION", "CSRD14u"), ("RNWEIR", "MILLBu")),
        (("JUNCTION", "CSRD14u"), ("RNWEIR", "MILLAu")),
        (("RNWEIR", "MILLAu"), ("RIVER", "MILLAd")),
        (("RIVER", "MILLAd"), ("RIVER", "RESOUT2u")),
        (("RIVER", "RESOUT2d"), ("RIVER", "CSRD13")),
        (("RIVER", "CSRD13"), ("RIVER", "CSRD12u")),
        (("JUNCTION", "CSRD12u"), ("RIVER", "CSRD12u")),
        (("JUNCTION", "CSRD12u"), ("RNWEIR", "MILLBu")),
        (("JUNCTION", "CSRD12u"), ("RIVER", "CSRD12d")),
        (("RIVER", "CSRD12d"), ("RIVER", "CSRD10")),
        (("RIVER", "CSRD10"), ("RIVER", "CSRD09")),
        (("RIVER", "CSRD09u"), ("RIVER", "CSRD09a")),
        (("JUNCTION", "CSRD09"), ("RIVER", "CSRD09")),
        (("JUNCTION", "CSRD09"), ("RIVER", "CSRD09u")),
        (("JUNCTION", "CSRD09"), ("RNWEIR", "ROAD1")),
        (("BERNOULLI", "CSRD09a"), ("RIVER", "CSRD09a")),
        (("BERNOULLI", "CSRD09a"), ("RIVER", "CSRD08u")),
        (("RIVER", "CSRD08u"), ("RIVER", "CSRD08a")),
        (("JUNCTION", "CSRD08a"), ("RIVER", "CSRD08a")),
        (("JUNCTION", "CSRD08a"), ("RIVER", "CSRD08")),
        (("JUNCTION", "CSRD08a"), ("RNWEIR", "ROAD1")),
        (("RIVER", "CSRD08"), ("RIVER", "CSRD07")),
        (("RIVER", "CSRD07"), ("RIVER", "CSRD06")),
        (("RIVER", "CSRD06"), ("RIVER", "CSRD05")),
        (("RIVER", "CSRD05"), ("RIVER", "CSRD04")),
        (("RIVER", "CSRD04"), ("RIVER", "CSRD03")),
        (("RIVER", "CSRD03"), ("RIVER", "CSRD02")),
        (("RIVER", "CSRD02"), ("RIVER", "CSRD02d")),
        (("JUNCTION", "CSRD02d"), ("RIVER", "CSRD02d")),
        (("JUNCTION", "CSRD02d"), ("RNWEIR", "RAILRDu")),
        (("JUNCTION", "CSRD02d"), ("BERNOULLI", "RAILBRu")),
        (("BERNOULLI", "RAILBRu"), ("JUNCTION", "RAILBRd")),
        (("RNWEIR", "RAILRDu"), ("JUNCTION", "RAILBRd")),
        (("JUNCTION", "RAILBRd"), ("RIVER", "CSRD01a")),
        (("RIVER", "CSRD01a"), ("RIVER", "CSRD01u")),
        (("RIVER", "CSRD01u"), ("RNWEIR", "CSRD01u")),
        (("RNWEIR", "CSRD01u"), ("RIVER", "CSRD01d")),
        (("RIVER", "CSRD01d"), ("RIVER", "CSRD01")),
        (("RIVER", "CSRD01"), ("INTERPOLATE", "DS.001")),
        (("INTERPOLATE", "DS.001"), ("INTERPOLATE", "DS.002")),
        (("INTERPOLATE", "DS.002"), ("INTERPOLATE", "DS.003")),
        (("INTERPOLATE", "DS.003"), ("INTERPOLATE", "DS.004")),
        (("INTERPOLATE", "DS.004"), ("INTERPOLATE", "DS.005")),
        (("INTERPOLATE", "DS.005"), ("INTERPOLATE", "DS.006")),
        (("INTERPOLATE", "DS.006"), ("RIVER", "DS2")),
        (("JUNCTION", "DS2"), ("RIVER", "DS2")),
        (("JUNCTION", "DS2"), ("RNWEIR", "FOOTa")),
        (("JUNCTION", "DS2"), ("BERNOULLI", "FOOTBRu")),
        (("RNWEIR", "FOOTa"), ("JUNCTION", "FOOTb")),
        (("JUNCTION", "FOOTb"), ("BERNOULLI", "FOOTBRu")),
        (("JUNCTION", "FOOTb"), ("RIVER", "DS3")),
        (("RIVER", "DS3"), ("RIVER", "DS4")),
        (("QHBDY", "DS4"), ("RIVER", "DS4")),
    ]

    actual = {frozenset((x.unit, x.name) for x in y) for y in actual_edges}
    expected = {frozenset(x) for x in expected_edges}

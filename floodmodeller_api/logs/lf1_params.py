...
data_to_extract = {
    ...
    "iterations": {"class": FloatMult, "prefix": "!!PlotI1", "stage" : "run", "names": ["iterations_simulated_time", "iterations_iter", "iterations_log(dt)"]},
    "convergence": {"class": FloatMult, "prefix": "!!PlotC1", "stage" : "run", "names": ["convergence_simulated_time", "convergence_flow", "convergence_level"]},
    "flow": {"class": FloatMult, "prefix": "!!PlotF1", "stage" : "run", "names": ["flow_simulated_time", "flow_inflow", "flow_outflow"]},
    "mass_error": {"class": FloatMult, "prefix": "!!Info1 Mass %error =", "stage" : "run", "names" : ["mass_error_simulated_time", "mass_error_mass_error"]},
    # end

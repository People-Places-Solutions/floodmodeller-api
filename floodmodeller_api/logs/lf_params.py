...
lf1_unsteady_data_to_extract = {
    ...
    # run
    "mass_error": {"class": TimeFloatMultParser, "prefix": "!!Info1 Mass %error =", "data_type": "all", "names": ["simulated_duplicate", "mass_error"], "before_index": True},
    ...
    "iterations": {"class": TimeFloatMultParser, "prefix": "!!PlotI1", "data_type": "all", "names": ["simulated_duplicate", "iter", "log(dt)"]},
    "convergence": {"class": TimeFloatMultParser, "prefix": "!!PlotC1", "data_type": "all", "names": ["simulated_duplicate", "flow", "level"]},
    "flow": {"class": TimeFloatMultParser, "prefix": "!!PlotF1", "data_type": "all", "names": ["simulated_duplicate", "inflow", "outflow"]},
    # end

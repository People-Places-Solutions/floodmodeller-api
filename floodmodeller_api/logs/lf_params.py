...
lf1_unsteady_data_to_extract = {
    ...
    "initial_volume": {
        "class": FloatSplitParser,
        "prefix": "^!!output1\s+Initial volume\s*:",
        "data_type": "last",
        "split": "m3",
        "use_regex": True,
    },
    "final_volume": {
        "class": FloatSplitParser,
        "prefix": "^!!output1\s+Final volume\s*:",
        "data_type": "last",
        "split": "m3",
        "use_regex": True,
    },
    "total_boundary_inflow": {
        "class": FloatSplitParser,
        "prefix": "^!!output1\s+Total boundary inflow\s*:",
        "data_type": "last",
        "split": "m3",
        "use_regex": True,
    },
    "total_boundary_outflow": {
        "class": FloatSplitParser,
        "prefix": "^!!output1\s+Total boundary outflow\s*:",
        "data_type": "last",
        "split": "m3",
        "use_regex": True,
    },
    "total_lat_link_inflow": {
        "class": FloatSplitParser,
        "prefix": "^!!output1\s+Total lat. link inflow\s*:",
        "data_type": "last",
        "split": "m3",
        "use_regex": True,
    },
    "total_lat_link_outflow": {
        "class": FloatSplitParser,
        "prefix": "^!!output1\s+Total lat. link outflow\s*:",
        "data_type": "last",
        "split": "m3",
        "use_regex": True,
    },
    "max_system_volume": {
        "class": FloatSplitParser,
        "prefix": "^!!output1\s+Max. system volume\s*:",
        "data_type": "last",
        "split": "m3",
        "use_regex": True,
    },
    "max_volume_increase": {
        "class": FloatSplitParser,
        "prefix": "^!!output1\s+Max. \|volume\| increase\s*:",
        "data_type": "last",
        "split": "m3",
        "use_regex": True,
    },
    "max_boundary_inflow": {
        "class": FloatSplitParser,
        "prefix": "^!!output1\s+Max. boundary inflow\s*:",
        "data_type": "last",
        "split": "m3",
        "use_regex": True,
    },
    "max_boundary_outflow": {
        "class": FloatSplitParser,
        "prefix": "^!!output1\s+Max. boundary outflow\s*:",
        "data_type": "last",
        "split": "m3",
        "use_regex": True,
    },
    "net_volume_increase": {
        "class": FloatSplitParser,
        "prefix": "^!!output1\s+Net increase in volume\s*:",
        "data_type": "last",
        "split": "m3",
        "use_regex": True,
    },
    "net_inflow_volume": {
        "class": FloatSplitParser,
        "prefix": "^!!output1\s+Net inflow volume\s*:",
        "data_type": "last",
        "split": "m3",
        "use_regex": True,
    },
    ...
    "mass_balance_error_2": {
        "class": FloatSplitParser,
        "prefix": "^!!output1\s+Mass balance error \[2\]\s*:",
        "data_type": "last",
        "split": "%",
        "use_regex": True,
    },
